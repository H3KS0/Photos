# Generated by Django 3.2.13 on 2024-05-26 12:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128)),
                ('date_dowloand', models.DateTimeField()),
                ('category_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='photography.photocategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='photography.pictures')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
